                      ...
                      Column(
                        children: [
                          ...
                          Container(
                            width: 120,
                            height: 200,
                            margin: EdgeInsets.only(top: 0, left: 1, right: 5, bottom: 0),
                            child: ElevatedButton(
...
//               height: double.infinity,
//               child: SvgPicture.asset(
//                 isFrontView ? 'assets/images/body-front.svg' : 'assets/images/body-back.svg',
//                 fit: BoxFit.contain,
//               ),
//             ),
//             Positioned(
...
//                             width: 37,
//                             height: 60,
//                             margin: EdgeInsets.only(top: 10, left: 25, right: 3, bottom: 90),
//                             child: ElevatedButton(
//                               // onPressed: () => _navigateTo(context, "bicep"),
//                               onPressed: () => _navigateTo(context, isFrontView ? "bicep": "tricep"),
//                               style: bodyButtonStyle,
//                               child: Text('LBicep', style: TextStyle(color: Colors.transparent)),
//                             ),
...
//                             width: 40,
//                             height: 50,
//                             margin: EdgeInsets.only(top: 0, left: 2, right: 10, bottom: 5),
//                             child: ElevatedButton(
//                               onPressed: () => _navigateTo(context, "shoulder"),
//                               style: bodyButtonStyle,
//                               child: Text('RS', style: TextStyle(color: Colors.transparent)),
...
//                             width: 40,
//                             height: 60,
//                             margin: EdgeInsets.only(top: 10, left: 2, right: 10, bottom: 90),
//                             child: ElevatedButton(
//                               onPressed: () => _navigateTo(context, isFrontView ? "bicep": "tricep"),
//                               style: bodyButtonStyle,
//                               child: Text('Rbicep', style: TextStyle(color: Colors.transparent)),
